...
export const siteConfig: SiteConfig = {
  ...
  defaultOgImageAlt: "Mordite Press publishers", // Alt text for the default Open Graph image, public/open-graph.png
  ...
  navigation: {
    ...
    social: [
      ...
      {
        title: "Matt's Instagram",
        url: "https://www.instagram.com/number_none/",
        icon: "instagram",
      },
    ],
  },
  ...
  homeOptions: {
    ...
    docs: {
      ...
      count: 2, // Number of docs to show
    },
    blurb: {
